...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/index.css?ver=1.1">
</head>
<body>
	<aside>
        ...
        <nav>
            <div class='logo_container'>
                ...
                <h2>
                    ...
                    <input type="text" placeholder="상품명 입력" name="keyword" value="${keyword}" />
                    <i class="fas fa-search" ><button type="submit" /></i>
                    </form>
                </h2>
                <ul>
